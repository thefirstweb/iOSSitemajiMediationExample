 ...
 */
@interface INMMoatNativeDisplayTracker : INMMoatBaseTracker
 ...
 * @return INMMoatNativeDisplayTracker instance
 */
+ (INMMoatNativeDisplayTracker *)trackerWithAdView:(UIView *)adView withAdIds:(NSDictionary *)adIds;
