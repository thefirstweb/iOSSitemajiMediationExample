 ...
 * @return INMMoatWebTracker instance
 */
+ (INMMoatWebTracker *)trackerWithWebComponent:(UIView *)webViewOrWebViewContainer;
...
+ (INMMoatWebTracker *)trackerWithAdView:(UIView *)adView withWebComponent:(UIView *)webViewOrWebViewContainer;
